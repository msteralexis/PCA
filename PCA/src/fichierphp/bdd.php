...
class Bdd {
    ...
    protected $serverName = '00';
    protected $userName = 'nameUser';
    protected $password = '000';
    protected $bddName = "nameDB";
    private $conn = '';
    ...
    public function insertUser($nom,$prenom, $mail) {
        $password = md5( '0000' ); 
        $res =  $this->conn->prepare(" INSERT INTO user (nom, prenom, mail, password)  VALUES ( ?, ?, ?, ? )");
        return $res->execute( array( $nom, $prenom, $mail, $password )) ;
    }
